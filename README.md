...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,react,nextjs,redux,typescript,discord,bash,firebase,threejs,postman,jest,materialui,graphql,stackoverflow,sass,bootstrap,styledcomponents,figma,vite,linux,netlify,git,github,gitlab,discord,vscode,androidstudio)](https://skillicons.dev)
